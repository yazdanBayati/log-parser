...
var testEnvManager_1 = require("../../envManager/testEnvManager");
...
describe('logError', function () {
    ...
    it('should reutrn 1 error log', function () {
        printHandler = new filePrintHandler_1.FilePrintHandler('error.json', logger);
        envManager = new testEnvManager_1.TestEnvManager();
    ...
    it('shoud return 0 error log', function () {
        var res = logFormatHandler.handle('./src/tests/mock_data/wrongformatlog.log');
        var errors = JSON.parse(res);
